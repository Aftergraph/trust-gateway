...
| 194 | `skill_sandbox_set` | mounts/147-skill-sandbox.js (FS-X2: {by, skillId, network, fsWrite} — operator set a per-skill sandbox profile; TG_SKILL_SANDBOX=1 only) |
| 195 | `skill_sandbox_reset` | mounts/147-skill-sandbox.js (FS-X2: {by, skillId, removed} — operator removed a sandbox profile; id only) |
| 196 | `skill_sandbox_listed` | mounts/147-skill-sandbox.js (FS-X2: {by, count} — operator listed sandbox profiles; count only) |
