...
- A2 token-streaming LANDET (aabac66). A3 markdown LANDET. BØLGE A KOMPLET (A1-A4). B1 fil-upload LANDET. D1 LANDET (12/12). E+F komplet (E1-E4, F1-F2) — mission-kæde + integrity-badge (verify synlig, broken aldrig skjult).
