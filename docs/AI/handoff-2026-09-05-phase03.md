...
- A2 token-streaming LANDET (aabac66). A3 markdown LANDET. BØLGE A KOMPLET (A1-A4). B1 fil-upload LANDET. D3 LANDET (BØLGE A+B+C komplet + D3). Tilbage: D1 mobil, D2 push/unread
