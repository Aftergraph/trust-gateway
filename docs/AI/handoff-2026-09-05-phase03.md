...
- A2 token-streaming LANDET (aabac66). A3 markdown LANDET. BØLGE A KOMPLET (A1-A4). B1 fil-upload LANDET. B3+C4 LANDET. Tilbage: B2 voice + D-bølgen (mobil/push/tema)
