...
- A2 token-streaming LANDET (aabac66). A3 markdown LANDET. BØLGE A KOMPLET (A1-A4). B1 fil-upload LANDET. D1 LANDET (12/12). G3 LANDET (CI grøn) — evidence-hash hele vejen: fødes med hash (G2 Seal), vises med verify-verdict i WORKS webui (G3: ok/tampered/unsealed), verificeres i TG mission-detail. Tamperdetektion end-to-end.
