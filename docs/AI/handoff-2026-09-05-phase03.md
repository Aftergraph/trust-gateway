...
- A2 token-streaming LANDET (aabac66). A3 markdown LANDET. BØLGE A KOMPLET (A1-A4). B1 fil-upload LANDET. C4 LANDET — BØLGE C KOMPLET (C1-C4). Tilbage: B2 voice, B3 knowledge-citations, D-bølgen (mobil/push/tema)
