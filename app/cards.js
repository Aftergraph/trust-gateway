'use strict';
// app/cards.js — schema validator + renderer for the 8 declarative primitives.
// XSS policy: all user/model-derived content uses textContent only, never innerHTML.
// Registers as TG_PANELS with id 'cards', title 'Adaptive Cards'.
// Also exports functions for Node.js testing and server-side use.
...
// ── Panel registration (browser only) ─────────────────────────────────────────────
(function () {
